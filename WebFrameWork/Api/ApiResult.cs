...
namespace WebFrameWork.Api
{
        ...
        where TData : class
    {
        ...
        public static implicit operator ApiResult<TData>(OkObjectResult data)
        {
            return new ApiResult<TData>(true, ApiResultStatusCode.Success, (TData)data.Value);
        }
        ...
        //        Message = "عملایت با موفقیت انجام شد",
        //        Data = value
        //    };
        //}
